...
Нарисуйте электронную диаграмму для библиотечной системы на основе следующих требований:
В библиотеке хранятся экземпляры книг. Каждая копия (экземпляр) имеет уникальный ключ.

### Задача 2

С помощью руководства https://spring.io/guides/gs/accessing-data-jpa/ , сделайте реализацию. 